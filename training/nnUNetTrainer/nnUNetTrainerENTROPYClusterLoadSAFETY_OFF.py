...
from nnunetv2.training.dataloading.cluster_data_loader_ENTROPY_SAFETY_OFF import nnUNetClusterDataLoader2D
...
class nnUNetTrainerENTROPYClusterLoadSAFETY_OFF(nnUNetTrainer):
    ...
    def get_dataloaders(self):
        print("USING MODIFIED DATALOADER_ENTROPY_Safety OFF")
