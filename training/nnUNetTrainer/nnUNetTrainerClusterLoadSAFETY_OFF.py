...
from nnunetv2.training.dataloading.cluster_data_loader_SAFETY_OFF import nnUNetClusterDataLoader2D
...
class nnUNetTrainerClusterLoadSAFETY_OFF(nnUNetTrainer):
    ...
    def get_dataloaders(self):
        print("USING MODIFIED DATALOADER_Safety OFF")
