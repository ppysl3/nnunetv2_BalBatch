...
from nnunetv2.training.dataloading.cluster_data_loader_3D import nnUNetClusterDataLoader3D
...
class nnUNetTrainer3DClusterLoad3D(nnUNetTrainer):
    ...
    def get_dataloaders(self):
        print("USING 3D MODIFIED DATALOADER")
        ...
        if allowed_num_processes == 0 or True==True:
            print("SingleThread")
    ...
    def get_plain_dataloaders(self, initial_patch_size: Tuple[int, ...], dim: int):
        ...
        if dim == 2:
            print("3D TRAINER SELECTED. Not compatable with 3D DATA")
            sys.exit()
        else:
            dl_tr = nnUNetClusterDataLoader3D(dataset_tr, self.batch_size,
                                       initial_patch_size,
